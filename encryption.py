...
def on_encrypt():
    ...
    if not text.strip():
        messagebox.showerror("Error", "Please enter a text you want to encrypt.")
        return
    try:
        ...
        messagebox.showerror("Error", f"An error occured while encrypting: {str(e)}")
...
root = tk.Tk()
root.title("Data Encryption with Chess960")
...
title_label = tk.Label(frame_encrypt, 
                      text="Data Encryption with Chess960", 
